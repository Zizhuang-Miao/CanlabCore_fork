...
render_on_surface_allowable_args = {'clim' 'cmaprange' 'color' 'colormap' 'colormapname' 'axis_handle' 'pos_colormap' 'neg_colormap', 'pos_min', 'neg_max', 'graybuffer', 'use_vertices_range', ...
